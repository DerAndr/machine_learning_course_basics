...
This directory contains the lecture example notebooks for Lecture 14: ML in Production.

## Files

- `example_01.ipynb` and `example_01.py`
  Title: ML in Production - Guided Practice
  Summary: Guided practice for packaging, validation, and monitoring in production ML.
