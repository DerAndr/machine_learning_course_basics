...
This directory contains the lecture example notebooks for Lecture 08: Time Series.

## Files

- `example_01.ipynb` and `example_01.py`
  Title: Data Preparation Function
  Summary: Forecasting pipeline with SARIMA, Random Forest, Prophet, and XGBoost.
