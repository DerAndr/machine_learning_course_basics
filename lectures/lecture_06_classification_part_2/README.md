# Lecture 06: Classification Part 2
...
- `lecture_examples/example_01.ipynb` and `lecture_examples/example_01.py`: Imbalanced Binary Classification. Imbalanced binary classification with resampling and threshold-aware metrics.
- `lecture_examples/example_02.ipynb` and `lecture_examples/example_02.py`: Multiclass Classification with Logistic Regression using One-vs-Rest and One-vs-One Strategies. Multiclass classification with native, OvR, and OvO logistic strategies.
